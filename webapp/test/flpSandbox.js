		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comlevibusinesshealthcheck-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlevibusinesshealthcheck-display": {
								"semanticObject": "comlevibusinesshealthcheck",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.levi.businesshealthcheck",
									"url": sap.ui.require.toUrl("com/levi/businesshealthcheck")
								}
							}
						}
					}
